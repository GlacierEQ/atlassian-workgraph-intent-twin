"""Workgraph Intent Twin — SCAFFOLD STUB.

Company lens: Atlassian (independent; no affiliation).
Bottleneck: Agent-driven Jira/Confluence changes lose intent alignment as workflows fan out across tickets and docs.
...
class WorkgraphIntentTwin:
    ...
    - `evaluate(req)` returns a WorkgraphIntentTwinReceipt
